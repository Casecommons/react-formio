		...
		items.length
			? _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{
							className:
								'list-group-item list-group-header hidden-xs hidden-md',
						},
						_react2.default.createElement(
							'div',
							{ className: 'row' },
							columns.map(function (column) {
								var key = column.key,
									...
									sort =
										_column$sort === undefined
											? false
											: _column$sort,
									_column$title = column.title,
									title =
										_column$title === undefined
											? ''
											: _column$title,
									width = column.width;
								...
								var sortKey = (0, _isString3.default)(sort)
									? sort
									: key;
								var ascSort = sortKey;
								...
								if (sortOrder === ascSort) {
									sortClass =
										'glyphicon glyphicon-triangle-top fa fa-caret-up';
			...
			: _react2.default.createElement('div', null, emptyText),
	);
}
