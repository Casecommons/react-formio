...
var FormBuilder = function FormBuilder(props) {
  ...
  var getPdfSrc = function getPdfSrc(providedForm) {
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    var providedPdfSrc = getPdfSrc(props.form);
