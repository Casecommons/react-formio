...
var _lib = require('f@ormio/js/lib');
...
var initAuth = exports.initAuth = function initAuth() {
  return function (dispatch) {
    var projectUrl = _lib.Formio.getProjectUrl();

    dispatch(requestUser());

    Promise.all([_lib.Formio.currentUser(), _lib.Formio.makeStaticRequest(projectUrl + '/access').then(function (result) {
    ...
    }).catch(function () {}), _lib.Formio.makeStaticRequest(projectUrl).then(function (project) {
...
var logout = exports.logout = function logout() {
  return function (dispatch) {
    _lib.Formio.logout().then(function () {
      dispatch(logoutUser());
    });
  };
};