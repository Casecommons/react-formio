...
var getForm = exports.getForm = function getForm(name) {
  ...
  return function (dispatch, getState) {
    ...
    var path = _lib.Formio.getProjectUrl() + '/' + (id ? 'form/' + id : name);
    var formio = new _lib.Formio(path);
...
var saveForm = exports.saveForm = function saveForm(name, form) {
  ...
  return function (dispatch) {
    ...
    var id = form._id;
    var path = _lib.Formio.getProjectUrl() + '/form' + (id ? '/' + id : '');
    var formio = new _lib.Formio(path);

    formio.saveForm(form).then(function (result) {
      var url = _lib.Formio.getProjectUrl() + '/form/' + result._id;
...
var deleteForm = exports.deleteForm = function deleteForm(name, id) {
  ...
  return function (dispatch) {
    var path = _lib.Formio.getProjectUrl() + '/form/' + id;
    var formio = new _lib.Formio(path);
